...
export const RANKS: RankInfo[] = [
  { id: 'rookie', name: 'Rookie', requiredCoins: 0, multiplier: 1.0, color: '#6B7280' },
  { id: 'bronze', name: 'Bronze', requiredCoins: 500, multiplier: 1.1, color: '#CD7F32' },
  { id: 'silver', name: 'Silver', requiredCoins: 2000, multiplier: 1.25, color: '#C0C0C0' },
  { id: 'gold', name: 'Gold', requiredCoins: 5000, multiplier: 1.5, color: '#FFD700' },
  { id: 'platinum', name: 'Platinum', requiredCoins: 15000, multiplier: 1.75, color: '#7DD3FC' },
  { id: 'diamond', name: 'Diamond', requiredCoins: 50000, multiplier: 2.0, color: '#A78BFA' },
];
